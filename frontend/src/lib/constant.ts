...
export const testimonials = [
  ...
  },
  {
    ...
    author: "Rameshwor Yadav",
    location: "From Siraha",
  ...
  },
  {
    ...
    author: "Sachhyam Pokharel",
    location: "From Gorkha",
  ...
  },
  {
    ...
    author: "Nikhil Basnet",
    location: "From Dhading",
...
export const faqs = [
  {
    question: "How much does a doctor visit with Digital Healthcare cost?",
    answer:
      "With insurance, you pay your copay based on your plan. We accept most plans, including DigitalCare. Without insurance, online doctor visits are $129. You can become a DigitalCare member and pay $44/visit. Membership is $55 for three months and $180 for a yearly membership.",
  },
  {
    question: "Do you accept health insurance?",
    answer:
      "Yes, we accept most major health insurance plans including DigitalCare, BlueCross BlueShield, Aetna, United Healthcare, Cigna, Humana, and many others. We also accept FSA and HSA payments.",
  },
  {
    question: "What conditions can Digital Healthcare doctors treat?",
    answer:
...
export const contactInfo = [
  ...
  {
    icon: Mail,
    text: "support@digitalhealthcare.com",
  },
  {
    icon: MapPin,
    text: "Available across Nepal",
  },
];
...
export const socials = [
  {
    name: "twitter",
    icon: Twitter,
    url: "https://twitter.com/digitalcare-plus",
  },
  {
    name: "facebook",
    icon: Facebook,
    url: "https://facebook.com/digitalcare-plus",
  },
  {
    name: "linkedin",
    icon: Linkedin,
    url: "https://linkedin.com/company/digitalcare-plus",
  },
  {
    name: "instagram",
    icon: Instagram,
    url: "https://instagram.com/digitalcare-plus",
  },
];
